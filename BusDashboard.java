...
public class BusDashboard extends JFrame implements ActionListener {
	...
	public BusDashboard() {
		...
		icon = new ImageIcon(getClass().getResource("Storage/Bus1.png"));
		...
		String[] from = { "Departure", "Dhaka", "Pabna", "Sylhet", "Barishal" };
		...
		String[] from2 = { "Arrival", "Dhaka", "Pabna", "Sylhet", "Barishal" };
		...
		String[] coach = { "Shohagh", "Shyamoli", "Ena", "Soadia", "Alhamra", "GreenLine" };
